...
class ExplorarDestinosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Leer y cargar el archivo JSON desde assets
        ...
        listView.onItemClickListener = AdapterView.OnItemClickListener { _, _, position, _ ->
            ...
            // Verificar que el mapa contenga todos los datos
            ...
            intent.putExtra("pais_destino", destinoSeleccionado["pais"] ?: "No disponible")  // Asigna un valor predeterminado si es null
    ...
    private fun leerDestinosDesdeJSON(): List<Map<String, String>> {
        ...
        // Iterar sobre el JSONArray y extraer los objetos individuales
